...
if recordVideoData
    if useMoistureData
        videoFile = VideoWriter('..\results\dmdAndKFTemperatureAndMoistureDataWithoutParticles.avi');
    else
        videoFile = VideoWriter('..\results\dmdAndKFTemperatureDataWithoutParticles.avi');
    end
    open(videoFile);
