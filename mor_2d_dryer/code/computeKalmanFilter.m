...
for i = 2:numTimeStepsWithoutParticles
    % predict state
    estimatedStatesInDMDSpaceCase1Temperature(:,i) = AtildeTemperature*estimatedStatesInDMDSpaceCase1Temperature(:,i-1) + BtildeTemperature*UCase1Temperature(i-1,:)';
...
for i = 2:numTimeStepsWithParticles
    % predict state
    estimatedStatesInDMDSpaceCase2Temperature(:,i) = AtildeTemperature*estimatedStatesInDMDSpaceCase2Temperature(:,i-1) + BtildeTemperature*UCase2Temperature(i-1,:)';
...
for i = 2:numTimeStepsWithoutParticles
    % predict state
    estimatedStatesInDMDSpaceCase1Humidity(:,i) = AtildeHumidity*estimatedStatesInDMDSpaceCase1Humidity(:,i-1) + BtildeHumidity*UCase1Humidity(i-1,:)';
...
for i = 2:numTimeStepsWithParticles
    % predict state
    estimatedStatesInDMDSpaceCase2Humidity(:,i) = AtildeHumidity*estimatedStatesInDMDSpaceCase2Humidity(:,i-1) + BtildeHumidity*UCase2Humidity(i-1,:)';
